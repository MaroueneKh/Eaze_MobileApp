import 'package:eaze/main.dart';
import 'package:eaze/views/user/components/profil.dart';
import 'package:eaze/views/user/layouts/main/main_tab.dart';
import 'package:eaze/views/user/layouts/register/registerone_view.dart';
import 'package:eaze/views/user/layouts/register/registertwo_view.dart';
import 'package:eaze/views/user/register_view.dart';
